...
//sets up security filter so certain pages can be accessed withpout logging in 
//restricts access to all other pages,redirects user to login if not authenticated
